...
int main(int argc, char const *argv[]) {
	...
	for (auto size : sizesets) {
		...
		auto compressResult = Lambda::Compress::zlibCompressBuffer(binData, compressed);
		...
		auto decompressResult = Lambda::Compress::zlibDecompressBuffer(compressed, restored);
