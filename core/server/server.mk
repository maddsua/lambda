...
LIB_CORE_SERVER_DEPS	=	core/server/instance.o core/server/connection.o core/server/handlers.o core/server/errorpage.o
...
core/server/handlers.o: core/server/handlers.cpp
