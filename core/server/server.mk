...
LIB_CORE_SERVER_DEPS	=	core/server/instance.o core/server/http/connection.o core/server/http/transport.o core/server/http/upgrade.o core/server/handlers/serverless.o core/server/handlers/connection.o core/server/websocket/context.o core/server/websocket/transport.o core/server/pages/templates.o core/server/pages/renderer.o core/server/pages/errorpage.o $(LIB_CORE_SERVER_PAGES)
