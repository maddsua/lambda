...
api_server.example$(EXEEXT): examples/api_server.o $(LAMBDA_LIBSHARED)
	g++ -s $(CFLAGS) examples/api_server.o $(LAMBDA_LIBSHARED) $(LINK_COMPRESS_LIBS) $(LINK_SYSTEM_LIBS) -o api_server.example$(EXEEXT)
...
kvserver.example$(EXEEXT): examples/kvserver.o $(LAMBDA_LIBSHARED)
	g++ -s $(CFLAGS) examples/kvserver.o $(LAMBDA_LIBSHARED) $(LINK_COMPRESS_LIBS) $(LINK_SYSTEM_LIBS) -o kvserver.example$(EXEEXT)
